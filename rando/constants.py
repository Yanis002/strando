...
class ItemId(IntEnum):
    ...
    ExtraItemId_PassengerAnoukiNoko = 157
    ExtraItemId_PassengerAnoukiKofu = 158
    ExtraItemId_PassengerCastleTownMona = 159
    ExtraItemId_PassengerCastleTownAlfonzo = 160
    ExtraItemId_PassengerSnowRealmFerrus = 161
    ExtraItemId_PassengerFireRealmFerrus = 162
    ExtraItemId_PassengerGoronVillageSnowGoron = 163
    ExtraItemId_PassengerGoronVillageCityGoron = 164
    ExtraItemId_PassengerMayscoreDovok = 165
    ExtraItemId_PassengerMayscoreMash = 166
    ExtraItemId_PassengerMayscoreMorris = 167
    ExtraItemId_PassengerMayscoreYamahiko = 168
    ExtraItemId_PassengerMayscoreWood = 169
    ExtraItemId_PassengerOutsetJoe = 170
    ExtraItemId_PassengerPirateHideoutWadatsumi = 171
...
item_id_to_name = {
    ItemId.Nothing.value: "Nothing",
    ItemId.NormalShield.value: "Normal Shield",
    ItemId.NormalSword.value: "Normal Sword",
    ItemId.Whirlwind.value: "Whirlwind",
    ItemId.BombBag.value: "Bomb Bag",
    ItemId.NormalBow.value: "Normal Bow",
    ItemId.Boomerang.value: "Boomerang",
    ItemId.Whip.value: "Whip",
    ItemId.SandRod.value: "Sand Rod",
    ItemId.Unk_9.value: "Unk 9",
    ItemId.NormalKey.value: "Small Key",
    ItemId.BossKey.value: "Boss Key",
    ItemId.GreenRupee.value: "Green Rupee",
    ItemId.BlueRupee.value: "Blue Rupee",
    ItemId.RedRupee.value: "Red Rupee",
    ItemId.BigGreenRupee.value: "Big Green Rupee",
    ItemId.BigRedRupee.value: "Big Red Rupee",
    ItemId.BigGoldRupee.value: "Big Gold Rupee",
    ItemId.ForceGem_18.value: "Force Gem 18",
    ItemId.ForceGem_19.value: "Force Gem 19",
    ItemId.ForceGem_20.value: "Force Gem 20",
    ItemId.ForestGlyph.value: "Forest Glyph",
    ItemId.SnowGlyph.value: "Snow Glyph",
    ItemId.OceanGlyph.value: "Ocean Glyph",
    ItemId.FireGlyph.value: "Fire Glyph",
    ItemId.Unk_25.value: "Forest Restoration Song",
    ItemId.Unk_26.value: "Snow Restoration Song",
    ItemId.Unk_27.value: "Ocean Restoration Song",
    ItemId.Unk_28.value: "Fire Restoration Song",
    ItemId.Unk_29.value: "Desert Restoration Song",
    ItemId.FinalTrack.value: "Final Track",
    ...
    ItemId.RecruitUniform.value: "Recruit Uniform",
    ItemId.PostmasterLetter.value: "Postmaster Letter",
    ItemId.HeartContainer.value: "Heart Container",
    ItemId.QuiverMedium.value: "Quiver Medium",
    ItemId.BombBagMedium.value: "Bomb Bag Medium",
    ItemId.ForceGem_43.value: "Force Gem 43",
    ItemId.ForceGem_44.value: "Force Gem 44",
    ItemId.ForceGem_45.value: "Force Gem 45",
    ItemId.ForceGem_46.value: "Force Gem 46",
    ItemId.ForceGem_47.value: "Force Gem 47",
    ItemId.ForceGem_48.value: "Force Gem 48",
    ItemId.ForceGem_49.value: "Force Gem 49",
    ItemId.ForceGem_50.value: "Force Gem 50",
    ItemId.ForceGem_51.value: "Force Gem 51",
    ItemId.ForceGem_52.value: "Force Gem 52",
    ItemId.ForceGem_53.value: "Force Gem 53",
    ItemId.ForceGem_54.value: "Force Gem 54",
    ItemId.ForceGem_55.value: "Force Gem 55",
    ItemId.ForceGem_56.value: "Force Gem 56",
    ItemId.ForceGem_57.value: "Force Gem 57",
    ItemId.ForceGem_58.value: "Force Gem 58",
    ItemId.ForceGem_59.value: "Force Gem 59",
    ItemId.ForceGem_60.value: "Force Gem 60",
    ItemId.ForceGem_61.value: "Force Gem 61",
    ItemId.PanFlute.value: "Pan Flute",
    ItemId.StampBook.value: "Stamp Book",
    ItemId.LightBow.value: "Light Bow",
    ItemId.LokomoSword.value: "Lokomo Sword",
    ItemId.TenPriceCard.value: "Ten Price Card",
    ItemId.RedPotion.value: "Red Potion",
    ItemId.PurplePotion.value: "Purple Potion",
    ItemId.YellowPotion.value: "Yellow Potion",
    ItemId.DemonFossil.value: "Demon Fossil",
    ItemId.StalfosSkull.value: "Stalfos Skull",
    ItemId.StarFragment.value: "Star Fragment",
    ItemId.BeeLarvae.value: "Bee Larvae",
    ItemId.WoodHeart.value: "Wood Heart",
    ItemId.DarkPearlLoop.value: "Dark Pearl Loop",
    ItemId.WhitePearlLoop.value: "White Pearl Loop",
    ItemId.RutoCrown.value: "Ruto Crown",
    ItemId.DragonScale.value: "Dragon Scale",
    ItemId.PirateNecklace.value: "Pirate Necklace",
    ItemId.PalaceDish.value: "Palace Dish",
    ItemId.GoronAmber.value: "Goron Amber",
    ItemId.MysticJade.value: "Mystic Jade",
    ItemId.AncientCoin.value: "Ancient Coin",
    ItemId.PricelessStone.value: "Priceless Stone",
    ItemId.RegalRing.value: "Regal Ring",
    ItemId.ArrowsRefill.value: "Arrows Refill",
    ItemId.BombsRefill.value: "Bombs Refill",
    ItemId.SoldOutSign.value: "Sold Out Sign",
    ItemId.AncientShield.value: "Ancient Shield",
    ItemId.QuiverLarge.value: "Quiver Large",
    ItemId.BombBagLarge.value: "Bomb Bag Large",
    ItemId.RandCommonTreasure.value: "Rand Common Treasure",
    ItemId.RandUncommonTreasure.value: "Rand Uncommon Treasure",
    ItemId.RandRareTreasure.value: "Rand Rare Treasure",
    ItemId.RandLegendaryTreasure.value: "Rand Legendary Treasure",
    ItemId.TearLight.value: "Tear of Light",
    ItemId.LightCompass.value: "Light Compass",
    ItemId.ScrollSpinAttack.value: "Scroll Spin Attack",
    ItemId.ScrollBeam.value: "Scroll Beam",
    ItemId.LinebeckLetter.value: "Linebeck Letter",
    ItemId.PanFluteSong_101.value: "PanFlute Song 101",
    ItemId.PanFluteSong_102.value: "PanFlute Song 102",
    ItemId.PanFluteSong_103.value: "PanFlute Song 103",
    ItemId.PanFluteSong_104.value: "PanFlute Song 104",
    ItemId.PanFluteSong_105.value: "PanFlute Song 105",
    ItemId.RabbitNet.value: "Rabbit Net",
    ItemId.BeedleCard.value: "Beedle Card",
    ItemId.SilverCard.value: "Silver Card",
    ItemId.GoldCard.value: "Gold Card",
    ItemId.PlatinumCard.value: "Platinum Card",
    ItemId.DiamondCard.value: "Diamond Card",
    ItemId.FreebieCard.value: "Freebie Card",
    ItemId.QuintupleCard.value: "Quintuple Card",
    ItemId.CarbenLetter.value: "Carben Letter",
    ItemId.RecruitUniform2.value: "Recruit Uniform 2",
    ItemId.EngineerUniform.value: "Engineer Uniform",
    ItemId.ExtraItemId_TearLight_1.value: "ToS 1 Tear of Light",
    ItemId.ExtraItemId_TearLight_2.value: "ToS 2 Tear of Light",
    ItemId.ExtraItemId_TearLight_3.value: "ToS 3 Tear of Light",
    ItemId.ExtraItemId_TearLight_4.value: "ToS 4 Tear of Light",
    ItemId.ExtraItemId_TearLight_5.value: "ToS 5 Tear of Light",
    ItemId.ExtraItemId_NormalKey_2.value: "ToS 2 Small Key",
    ItemId.ExtraItemId_NormalKey_4.value: "ToS 4 Small Key",
    ItemId.ExtraItemId_NormalKey_5.value: "ToS 5 Small Key",
    ItemId.ExtraItemId_NormalKey_6.value: "ToS 6 Small Key",
    ItemId.ExtraItemId_NormalKey_Tunnel.value: "Tunnel Small Key",
    ItemId.ExtraItemId_NormalKey_Wooded.value: "Wooded Temple Small Key",
    ItemId.ExtraItemId_NormalKey_Blizzard.value: "Blizzard Temple Small Key",
    ItemId.ExtraItemId_NormalKey_Marine.value: "Marine Temple Small Key",
    ItemId.ExtraItemId_NormalKey_Mountain.value: "Mountain Temple Small Key",
    ItemId.ExtraItemId_NormalKey_Desert.value: "Desert Temple Small Key",
    ItemId.ExtraItemId_ForestSource.value: "Forest Source",
    ItemId.ExtraItemId_SnowSource.value: "Snow Source",
    ItemId.ExtraItemId_OceanSource.value: "Ocean Source",
    ItemId.ExtraItemId_FireSource.value: "Fire Source",
    ItemId.ExtraItemId_SandSource.value: "Sand Source",
    ItemId.ExtraItemId_StampTowerOfSpirits.value: "Tower of Spirits Stamp",
    ItemId.ExtraItemId_StampCastleTown.value: "Castle Town Stamp",
    ItemId.ExtraItemId_StampOutsetVillage.value: "Outset Village Stamp",
    ItemId.ExtraItemId_StampMayscore.value: "Mayscore Stamp",
    ItemId.ExtraItemId_StampWoodlandSanctuary.value: "Woodland Sanctuary Stamp",
    ItemId.ExtraItemId_StampAnoukiVillage.value: "Anouki Village Stamp",
    ItemId.ExtraItemId_StampSnowfallSanctuary.value: "Snowfall Sanctuary Stamp",
    ItemId.ExtraItemId_StampPapuziaVillage.value: "Papuzia Village Stamp",
    ItemId.ExtraItemId_StampIslandSanctuary.value: "Island Sanctuary Stamp",
    ItemId.ExtraItemId_StampGoronVillage.value: "Goron Village Stamp",
    ItemId.ExtraItemId_StampValleySanctuary.value: "Valley Sanctuary Stamp",
    ItemId.ExtraItemId_StampDuneSanctuary.value: "Dune Sanctuary Stamp",
    ItemId.ExtraItemId_StampWoodedTemple.value: "Wooded Temple Stamp",
    ItemId.ExtraItemId_StampBlizzardTemple.value: "Blizzard Temple Stamp",
    ItemId.ExtraItemId_StampMarineTemple.value: "Marine Temple Stamp",
    ItemId.ExtraItemId_StampMountainTemple.value: "Mountain Temple Stamp",
    ItemId.ExtraItemId_StampDesertTemple.value: "Desert Temple Stamp",
    ItemId.ExtraItemId_StampPirateHideout.value: "Pirate Hideout Stamp",
    ItemId.ExtraItemId_StampTradingPost.value: "Trading Post Stamp",
    ItemId.ExtraItemId_StampIcySpring.value: "Icy Spring Stamp",
    ItemId.ExtraItemId_PassengerAnoukiNoko.value: "Passenger Noko",
    ItemId.ExtraItemId_PassengerAnoukiKofu.value: "Passenger Kofu",
    ItemId.ExtraItemId_PassengerCastleTownMona.value: "Passenger Mona",
    ItemId.ExtraItemId_PassengerCastleTownAlfonzo.value: "Passenger Alfonzo",
    ItemId.ExtraItemId_PassengerSnowRealmFerrus.value: "Passenger Ferrus (Snow Realm)",
    ItemId.ExtraItemId_PassengerFireRealmFerrus.value: "Passenger Ferrus (Fire Realm)",
    ItemId.ExtraItemId_PassengerGoronVillageSnowGoron.value: "Passenger Snow Goron",
    ItemId.ExtraItemId_PassengerGoronVillageCityGoron.value: "Passenger City Goron",
    ItemId.ExtraItemId_PassengerMayscoreDovok.value: "Passenger Dovok",
    ItemId.ExtraItemId_PassengerMayscoreMash.value: "Passenger Mash",
    ItemId.ExtraItemId_PassengerMayscoreMorris.value: "Passenger Morris",
    ItemId.ExtraItemId_PassengerMayscoreYamahiko.value: "Passenger Yamahiko",
    ItemId.ExtraItemId_PassengerMayscoreWood.value: "Passenger Wood",
    ItemId.ExtraItemId_PassengerOutsetJoe.value: "Passenger OutsetJoe",
    ItemId.ExtraItemId_PassengerPirateHideoutWadatsumi.value: "Passenger Wadatsumi",
